...
func.func @conv_2d_nchw_fchw(%in: !input_tensor_t, %wei: !weight_tensor_t) -> !output_tensor_t {
  %cst_0 = arith.constant 0.0 : ${DT}
  %empty = tensor.empty() : !output_tensor_t
  %fill = linalg.fill ins(%cst_0 : ${DT}) outs(%empty : !output_tensor_t) -> !output_tensor_t
  %res = linalg.conv_2d_nchw_fchw
    {dilations = dense<1> : tensor<2xi64>, strides = dense<1> : tensor<2xi64> }
     ins(%in, %wei: !input_tensor_t, !weight_tensor_t)
    outs(%fill: !output_tensor_t) -> !output_tensor_t
