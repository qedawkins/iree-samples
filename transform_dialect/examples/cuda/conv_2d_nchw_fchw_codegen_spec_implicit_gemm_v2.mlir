...
^bb1(%variant_op: !pdl.operation):
  ...
  %forall, %tiled_matmul =
    transform.iree.tile_to_forall_and_workgroup_count_region %matmul tile_sizes [1, 16, 64]
  ...
  // ==============================================================
  %forall_l3, %matmul_l3 =
  transform.structured.tile_to_forall_op %matmul_loopk num_threads [0, 1, 4]
